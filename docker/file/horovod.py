...
class ScheduledOptimizer(hvd._DistributedOptimizer):
    ...
    def __init__(self, model, hvd_opt, num_steps=10**6, delta_1=0, delta_2=0, O_lay=[0], O_num=[0]):
        ...
        core.start(rank=self._rank, arch="allreduce", delta_1=self._delta_1, delta_2=self._delta_2, O_lay=self._O_lay, O_num=self._O_num)
